...
public class Ex3Actions{
	...
	public String chooseFile(String[] files){
		...
		public Ex3DataHandler createMap(String fileName){
			String lines = "";
			...
			Ex3DataHandler kp = new Ex3DataHandler(listOfWords, keyPair, lineLimit, wordLimit, fileName);
		return kp;
	}	
	...
	public void selection(String[]files){
		...
		while(notFinished){
			...
			Ex3DataHandler kp = createMap(fileName);
	...
	public void searchTable(Ex3DataHandler kp){
	...
	public void printTable(Ex3DataHandler kp){
		LinkedHashMap<String, String> keyPair = kp.getKeyPair();
	...
	public void editTable(Ex3DataHandler kp){
		retrieveValue(kp);
	}
	
	public void retrieveValue(Ex3DataHandler kp){
		LinkedHashMap<String, String> keyPair = kp.getKeyPair();
	...
	public void updateFile(Ex3DataHandler kp, String oldValue, String newValue){
	...
	public void addRow(Ex3DataHandler kp){
		ArrayList<ArrayList<String>> listOfLines = createRows(kp);
		printAddedRows(listOfLines, kp.getFileName());
	}
	
	public ArrayList<ArrayList<String>> createRows(Ex3DataHandler kp){
